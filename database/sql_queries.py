...
INSERT INTO transactions (SENDER_TELEGRAM_ID, RECIPIENT_TELEGRAM_ID, AMOUNT)
VALUES (?, ?, ?)
"""

SELECT_WALLET_BALANCE_BY_USERNAME_QUERY = """
SELECT COALESCE(BALANCE, 0) AS balance
FROM telegram_users
WHERE USERNAME = ? OR FIRST_NAME = ?;
"""

UPDATE_WALLET_DECREMENT_QUERY = """
UPDATE wallet
SET AMOUNT = AMOUNT - ?
WHERE USER_TELEGRAM_ID = ?;
"""

UPDATE_WALLET_INCREMENT_QUERY = """
UPDATE wallet
SET AMOUNT = AMOUNT + ?
WHERE USER_TELEGRAM_ID = ?;
"""

SELECT_USER_BY_USERNAME_OR_FIRST_NAME_QUERY = """
SELECT TELEGRAM_ID FROM telegram_users WHERE USERNAME = ? OR FIRST_NAME = ?;
"""